...
This guide was based on the original [title] guide by Zer0CoolX located here: [https://github.com/Zer0CoolX/Fedora-KDE-Minimal-Install-Guide](https://github.com/Zer0CoolX/Fedora-KDE-Minimal-Install-Guide).

This is a guide to install Fedora Linux with the KDE Plasma Desktop Environment (DE) from a minimal Fedora installation. This will allow better control over which packages are included in Fedora KDE and result in a cleaner, lighter Fedora installation than the official Fedora KDE spin offers. The guide will provide step-by-step instructions to accomplish installing the KDE DE on top of a minimal Fedora install. There will also be optional, simple scripts to help with the process of installing the required packages to setup KDE on the aforementioned minimal Fedora installation.
